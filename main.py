...
def game():
    ...
    # Background Image
    game_background = pygame.transform.scale(pygame.image.load('bg5.jpg'), (WIDTH, HEIGHT))
    ...
    def game_over_text():
        game_over_text = game_over_font.render('GAME OVER', True, (255, 20, 255))
    ...
    while run:
        ...
        for i in range(number_of_enemies):
            ...
            if collision:
                ...
                collision_noise = pygame.mixer.Sound('boom.mp3')
